...
// stores the return of getRandomQuote() in var randomQuote which is used to access properties of the object and print them as strings between html tags.  calls getRandomRGB().    
function printQuote() {
